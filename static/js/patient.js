...
async function loadPage(page) {
    ...
    if (page === 'submit_report') {
        ...
        content.innerHTML = `
            <div class="d-flex align-items-center mb-4 text-danger border-bottom border-danger pb-3">
                <div class="bg-danger text-white rounded-circle d-flex align-items-center justify-content-center me-3 shadow-sm" style="width: 48px; height: 48px;">
                    <i class="fas fa-ambulance fa-lg"></i>
                </div>
                <div>
                    <h3 class="m-0 fw-bold text-danger">Emergency Assistance</h3>
                    <p class="text-muted mb-0 small">Direct emergency helplines — click any number to call immediately</p>
                </div>
            </div>

            <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px; overflow: hidden;">
                <div class="card-header bg-danger text-white py-3">
                    <h5 class="m-0 fw-bold"><i class="fas fa-phone-square-alt me-2"></i> Emergency Helpline Numbers</h5>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped align-middle mb-0">
                            <thead class="table-dark" style="background-color: #1e293b;">
                                <tr>
                                    <th style="width: 20%;" class="ps-3">📞 Number</th>
                                    <th style="width: 30%;">🚨 Type of help</th>
                                    <th style="width: 50%;">When to use</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:112" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 112
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">🚨 All-in-one emergency</strong></td>
                                    <td class="text-muted">Any serious emergency — medical, police, fire, rescue, etc.</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:108" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 108
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">🚑 Emergency ambulance</strong></td>
                                    <td class="text-muted">Accident, critical illness, unconscious person, severe injury, heart/breathing emergency, etc.</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:102" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 102
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">🚑 Ambulance / patient transport</strong></td>
                                    <td class="text-muted">Mainly pregnancy, newborn/children and related public-health transport services; availability/use varies by state</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:100" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 100
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">👮 Police</strong></td>
                                    <td class="text-muted">Crime, assault, danger, security/police assistance</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:101" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 101
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">🔥 Fire & rescue</strong></td>
                                    <td class="text-muted">Fire, building rescue and related emergencies</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:1098" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 1098
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">👶 Child Helpline</strong></td>
                                    <td class="text-muted">Child in distress or needing protection</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:1091" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 1091
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">👩 Women Helpline</strong></td>
                                    <td class="text-muted">Women in distress/emergency assistance</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:1070" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 1070
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">🌪️ Disaster / relief</strong></td>
                                    <td class="text-muted">Disaster and rescue/relief situations; state implementation can vary</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:1073" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 1073
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">🚗 Road accident</strong></td>
                                    <td class="text-muted">Road/traffic accident assistance; state availability can vary</td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                        <a href="tel:104" class="btn btn-danger btn-sm fw-bold px-3 py-1 shadow-sm text-nowrap" style="border-radius: 20px;">
                                            <i class="fas fa-phone-alt me-1"></i> 104
                                        </a>
                                    </td>
                                    <td><strong class="text-dark">🏥 Health helpline</strong></td>
                                    <td class="text-muted">Health advice and certain health-related services; Maharashtra lists it for health advice, blood availability, grievance redressal and mental-health counselling</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
async function startVideoCall(doctorId, doctorName) {
    ...
    content.innerHTML = `
        <div class="text-center py-5">
            ...
            <p class="text-muted mb-4">Waiting for the doctor to accept the secure video line.</p>
            <div class="d-flex justify-content-center gap-3">
                <button class="btn btn-outline-secondary shadow-sm px-4" onclick="cancelCall()">End Call</button>
                <button class="btn btn-success shadow-sm px-4 fw-bold" onclick="forceJoinVideoCall()"><i class="fas fa-video me-1"></i> Join Video Room Directly</button>
            </div>
        </div>
    `;
...
async function startVideoCallToDoctor(doctorId, doctorName, reportId) {
    ...
    content.innerHTML = `
        <div class="text-center py-5">
            ...
            <p class="text-muted mb-2">Waiting for the doctor to accept the secure video line.</p>
            <small class="text-muted d-block mb-4 fst-italic">Regarding Report #${reportId}</small>
            <div class="d-flex justify-content-center gap-3">
                <button class="btn btn-outline-secondary shadow-sm px-4" onclick="cancelCallToDoctor()">
                    <i class="fas fa-times me-1"></i> Cancel Call
                </button>
                <button class="btn btn-success shadow-sm px-4 fw-bold" onclick="forceJoinVideoCall()">
                    <i class="fas fa-video me-1"></i> Join Video Room Directly
                </button>
            </div>
        </div>
    `;
...
function cancelCallToDoctor() {
    if (callPollingInterval) clearInterval(callPollingInterval);
    loadPage('history');
}

function forceJoinVideoCall() {
    if (callPollingInterval) clearInterval(callPollingInterval);
    if (window.currentCallId) {
        startJitsiCall('MedAI-Room-' + window.currentCallId);
    } else {
    ...
    try {
        ...
        if (data.status === 'accepted') {
            ...
            document.getElementById('content').innerHTML = `
                <div class="text-center py-5">
                    <div class="bg-danger text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-3 shadow" style="width:70px;height:70px;font-size:1.8rem;">
                        <i class="fas fa-phone-slash"></i>
                    </div>
                    <h3 class="text-danger fw-bold mb-2">Call Ended / Declined</h3>
                    <p class="text-muted mb-4">The doctor is unavailable or declined the call.</p>
                    <button class="btn btn-primary shadow-sm px-4 fw-bold" onclick="loadPage('history')">
                        <i class="fas fa-arrow-left me-2"></i> Return to History
                    </button>
                </div>
            `;
        }
